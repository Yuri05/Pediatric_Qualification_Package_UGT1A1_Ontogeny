...
To qualify the OSP suite for the pediatric translation of the pharmacokinetics of new drugs that are metabolized by UGT1A1, the following probe substance was included:

- Raltegravir[[Raltegravir-Model](#3-references)]
